...
const char *gengetopt_args_info_help[] = {
  ...
  "  -i, --input-analysis=STRING   path of analysis data",
  "  -I, --input-reconstruction=STRING\n                                path of reconstruction data",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->input_analysis_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->input_analysis_arg = NULL;
  args_info->input_analysis_orig = NULL;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->input_analysis_arg));
  free_string_field (&(args_info->input_analysis_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->input_analysis_given)
    write_into_file(outfile, "input-analysis", args_info->input_analysis_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->input_analysis_given)
    {
      fprintf (stderr, "%s: '--input-analysis' ('-i') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'i':	/* path of analysis data.  */
        
        
          if (update_arg( (void *)&(args_info->input_analysis_arg), 
               &(args_info->input_analysis_orig), &(args_info->input_analysis_given),
              &(local_args_info.input_analysis_given), optarg, 0, 0, ARG_STRING,
          ...
          break;
        case 'I':	/* path of reconstruction data.  */
